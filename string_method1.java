public class string_method1 {
    public static void main(String[] args) {
        ...
        // remove all the extra gaps before and after the string
        String trimmed_first_name = first_name.trim();
        System.out.println("Trimmed:" + trimmed_first_name);
        String sub_string = name.substring(3);
        // remove all the elements befrore the given index value
        System.out.println("substring:" + sub_string);
        String new_substring = name.substring(6, 11);
        // print the string between the brginner index and the last index end is
        // excluding and start is including
        System.out.println(new_substring);
        // method name. replce is used to replce the cheracter
        String replaced_string = name.replace("RAIFUL", "arif");
        ...
        System.out.println("Last index of 'l':" + new_lastindexof);
        // if given cgar is nit in given index then it will return -1
